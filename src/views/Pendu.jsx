...
import { Playing } from '../componentes/PlayingCard';
import { EndGame } from '../componentes/EndGameCard';
import { setImagesFunc } from '../componentes/imagesFunc';
import { Dictionary } from '../componentes/Dictionary';
        ...
        <section style={{ backgroundColor: "#4B515D" }}>
            <MDBContainer className='pb-5'>
                <MDBRow className='justify-content-center'>
                    <MDBCardTitle className='text-center text-light my-md-5 my-4 display-4'>HANGMAN</MDBCardTitle>
                    <MDBCol >
                        <MDBCard >
                            <MDBCardBody>
                                {
